...
companion object {
    val predefinedSpecialists = listOf(
        ...
        Specialist(8, "Obstetrics and Gynecology (OB/GYN)"),
        ...
        Specialist(18, "Allergy and Immunology"),
        Specialist(19, "Anesthesiology"),
        Specialist(20, "Critical Care Medicine"),
        ...
        Specialist(29, "Physical Medicine and Rehabilitation (Physiatry)"),
